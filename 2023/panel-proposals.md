...
New version according the comments: ** Bridging the Gap: Platforms for Public Archaeology and Storytelling**

Archaeology faces a unique challenge—the need to balance meticulous data collection for academics while making discoveries accessible to the public in an engaging way. Technology, particularly GIS and open-source tools like QGIS and Grass, has transformed academic data analysis. Initiatives like SITAR, Wikimedia Commons, and Open Context aim to share data publicly, but challenges remain, including data quality issues on platforms like Wikidata. Our panel explores an almost uncharted territory—the intersection of knowledge sharing, data quality, public archaeology, history, and storytelling. We focus on innovative platforms bridging this gap, fostering collaboration, cooperation, and standardization.
Key Points:
- Innovative Platforms: We seek papers discussing platforms that merge academic research and public engagement while ensuring data quality. Platforms like Wikipedia, Wikidata, and OpenHistoryMap provide a reference point.
- Clear Focus: Our panel aims to delve into the specifics of creating containers for public archaeology, history, and storytelling integration.
In conclusion, we invite contributions that illuminate the hybrid territory where academic archaeology meets public engagement. We welcome insights into innovative platforms bridging data quality and knowledge sharing, with a focus on public archaeology, history, and storytelling integration.
